...
The current implementation snapshot is [Current Implemented Systems](../current-implemented-systems.md), and completed stage backlogs through Stage 2.2 are archived in this directory.
