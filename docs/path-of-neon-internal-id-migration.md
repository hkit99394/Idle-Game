...
## Stage 2.6 Closure Snapshot

Stage 2.6 completed static content id migration in focused slices while preserving save compatibility.
...
- No static content-id rename category remains open in Stage 2.6. Stage 2.7 completed save resource/progress field migration.

## Stage 2.7 Closure Snapshot

Stage 2.7 completed owned resource/progress field migration and moved saves to version `13`.
...
- Slice 92.5 updated web save diagnostics, import/export, reset, and storage-key/schema-migration coverage.
- Slice 92.6 confirmed simulator/support tooling continuity and documented that generated balance reward columns remain static authoring metrics, not save fields.
- Slice 92.7 completed stale-scan classification, validation, docs closure, and archival.
...
- deferred save-field, combat-symbol, or report-symbol work;
...
Cognitive Intrusion implementation is separate from these migration slices. It completed in [Archived Stage 3.0 Backlog](archive/stage-3.0-backlog.md), using the refreshed [Cognitive Intrusion Prototype Contract](cognitive-intrusion-prototype-contract.md) after Stage 2.9 hardening confirmed the current combat vocabulary was stable enough to avoid churn.
...
8. Stage 3.0: Cognitive Intrusion Prototype, completed in [Archived Stage 3.0 Backlog](archive/stage-3.0-backlog.md) from the refreshed contract without naming or compatibility churn.
