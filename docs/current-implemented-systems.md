...
- The active Stage 2.3 planning backlog is [Stage 2.3 Backlog](stage-2.3-backlog.md), focused on the display-safe Path of Neon design pivot.
- Completed backlogs through Stage 2.2 live in `docs/archive`.
