...
- The retheme has its first deeper mechanic beyond copy replacement: Stage 3.0 implemented Intrusion through the [Cognitive Intrusion Prototype Contract](cognitive-intrusion-prototype-contract.md), Stage 3.1 closed District Heat contract and pacing hardening at [Archived Stage 3.1 Backlog](archive/stage-3.1-backlog.md), Stage 3.2 closed pacing parity and heat readiness at [Archived Stage 3.2 Backlog](archive/stage-3.2-backlog.md), and Stage 3.3 closed offline parity, Black Iron visible-debt cleanup, and the heat promotion recheck at [Archived Stage 3.3 Backlog](archive/stage-3.3-backlog.md).
