...
- The retheme is intended to become deeper than copy replacement: [Stage 3.0 Backlog: Cognitive Intrusion Prototype](stage-3.0-backlog.md) is the active implementation backlog for the selected first mechanic, and [Cognitive Intrusion Prototype Contract](cognitive-intrusion-prototype-contract.md) is its boundary contract. District heat, augment loadouts, network operations, countermeasure economy, and AI raid events remain deferred.
...
- Stage 3.0 is active at [Stage 3.0 Backlog: Cognitive Intrusion Prototype](stage-3.0-backlog.md). It owns Epics 95 and 96: contract adoption plus the smallest useful Cognitive Intrusion implementation. Stage 3.0 should not add save/export/event/taxonomy churn or broaden into District Heat, hostile Intrusion, or broad balance retuning.
