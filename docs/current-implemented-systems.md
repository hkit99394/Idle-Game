...
- The active Stage 2.6 planning backlog is [Stage 2.6 Backlog](stage-2.6-backlog.md), focused on static content id migration for enemies, heroes, skills, styles, equipment, assignments, medicines, statuses, and tactics. Slice 91.1 is complete in [Stage 2.6 Content Id Preflight](stage-2.6-content-id-preflight.md), which owns the migrate/keep/defer content-id matrix.
