...
const prototypeDemonCultEnemies: StaticDataForSupportDecision["enemies"] = [
  {
    ...
    level: 9,
    baseStats: {
      maxBodyIntegrity: 980,
      maxContextStability: 520,
      kineticAttack: 26,
      cognitiveAttack: 44,
      kineticDefense: 24,
      cognitiveDefense: 34,
  ...
  },
  {
    ...
    level: 10,
    baseStats: {
      maxBodyIntegrity: 1350,
      maxContextStability: 560,
      kineticAttack: 48,
      cognitiveAttack: 36,
      kineticDefense: 30,
      cognitiveDefense: 32,
  ...
  },
  {
    ...
    level: 11,
    baseStats: {
      maxBodyIntegrity: 2600,
      maxContextStability: 980,
      kineticAttack: 70,
      cognitiveAttack: 58,
      kineticDefense: 40,
      cognitiveDefense: 42,
